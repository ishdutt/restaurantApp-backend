...
//Favorite: https://localhost:3443/favorites
...
favoriteRouter.use(bodyParser.json());
  ...
  //THis is the main area to be investigated

favoriteRouter
  .route("/")
  .options(cors.corsWithOptions, (req, res) => {
    console.log("Yahi hai Error ki jaddd............")
    res.sendStatus(200);
  })
    ...
    Favorites.findOne({ user: req.user._id })
      ...
      .then(
        favorites => {
          ...
          if(favorites === null)
          {
            console.log("E to khali hai re baba")
            res.json({dishes: []});
          }
	          
          else{
            console.log("Ye bhara hai")
            res.json(favorites);}
        },
        err => next(err)
      )
  ...
  .post(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    console.log("Ye hai error kis jad bhai")
...
favoriteRouter
  ...
  //THis is the main area to be investigated
  .post(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    console.log("Kudo kun is here worry not..")
    Favorites.findOne({ user: req.user._id }).then(favorite => {
      if (favorite) {
